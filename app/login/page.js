...
useEffect(() => {
  ...
  const submitLinks = async () => {
   ...
   const r = await fetch("https://linktree-app-uv1m.vercel.app/api/add", requestOptions)
...
<div>    
<div className="">
<h1 className='font-semibold text-3xl p-9'>Linktree</h1>
        </div>
        ...
        <div className='flex flex-col'>
            <div className="flex flex-col gap-3 justify-center items-center">
                ...
                <p className='text-zinc-700'>Log in to your Linktree</p>
 ...
 <div className='flex flex-col gap-3 items-center justify-center' >
            ...
            <div className='items-center justify-content text-sm  text-center flex flex-col gap-5'>
              ...
              <span className='text-zinc-500 text-xl'>OR</span>
            </div>
            <div className="flex flex-col gap-4">
               <button onClick={() => { signIn("github") }}

          className="bg-white flex items-center justify-center  text-black border border-gray-200 hover:bg-[#f6f7f5] p-3 w-[30vw] rounded-full font-medium  focus:outline-none  ">
          ...
          <span>Sign up with Github</span>
                ...
                <button  className="bg-white flex items-center justify-center  text-black border border-gray-200 hover:bg-[#f6f7f5] p-3 w-[30vw] rounded-full font-medium  focus:outline-none "
         >
          <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
...
<div>
   <Image src="/images/image1.png" alt="image" width={400} height={400} className='w-full h-screen object-cover' />
</div>
  <ToastContainer />
    </section>
   </main>
